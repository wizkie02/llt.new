...
const Layout = ({ children }: LayoutProps) => {
  ...
  return (
    <>      {/* Hiệu ứng loading */}
      ...
      <main className="min-h-screen w-full overflow-x-hidden bg-gradient-to-b from-[#F8FAFC] to-[#F2F7FC] transition-all duration-500 relative">
