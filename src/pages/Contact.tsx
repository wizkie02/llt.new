  ...
  return (
    <div className={`min-h-screen ${theme === 'light' ? 'bg-[#F7F9FC] text-[#2A3B4A]' : 'bg-[#1A202C] text-[#F7F8F9]'}`}>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 max-w-7xl mx-auto">
            ...
            <div className="lg:col-span-3 space-y-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-4 rounded-xl bg-white dark:bg-gray-800 shadow-sm border border-gray-100 dark:border-gray-700 hover:border-[#58b7e8] transition-colors duration-300">
                    ...
                    <p className="text-sm opacity-80 pl-1">
                  ...
                  <div className="p-4 rounded-xl bg-white dark:bg-gray-800 shadow-sm border border-gray-100 dark:border-gray-700 hover:border-[#6dc0eb] transition-colors duration-300">
                    <div className="flex items-center mb-3">
                      <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#0093DE] flex items-center justify-center text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="lg:col-span-2 h-full">
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-8 h-full flex flex-col">
                <div className="text-center mb-8">
                  <span className="inline-block px-4 py-1 rounded-full bg-[#daeef6] text-[#0093DE] text-sm font-medium mb-4">
                    Send Message
                  </span>
                ...
                <form className="space-y-6 max-w-xl mx-auto flex-1 flex flex-col">
                  ...
                  <button 
                    type="submit"
                    className="w-full bg-[#0093DE] hover:bg-[#0b98e0] text-white font-bold py-3 px-4 rounded-xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg"
                  >
                    Send Message
                  </button>
                </form>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <button 
          className="w-16 h-16 rounded-full bg-[#0093DE] text-white shadow-lg flex items-center justify-center hover:bg-[#0b98e0] transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl relative overflow-hidden"
