      ...
      <div className="pt-20 pb-8">
        <div className="p-6 mx-auto max-w-7xl">
          ...
          <div className="mb-8 text-center">
            <div className="inline-flex justify-center items-center mb-4 w-16 h-16 rounded-full" style={{ backgroundColor: '#0093DE' }}>
              <Users className="w-8 h-8 text-white" />
            </div>
            <h1 className="mb-3 text-4xl font-bold text-gray-900">Admin Account Management</h1>
          ...
          {success && (
            <Alert className="mb-6 bg-green-50 border-green-200 shadow-lg">
          ...
          {/* Action Buttons Card */}
          <Card className="mb-8 border-0 shadow-lg backdrop-blur-sm bg-white/80">
            <CardContent className="p-6">              <div className="flex flex-col gap-4 justify-center sm:flex-row sm:justify-start">
              {isSuperAdmin && (
                <Button
              ...
              >
                ...
                onClick={fetchAdmins}
                disabled={loading}
                className="px-6 py-3 font-medium text-gray-700 rounded-2xl border-2 border-gray-300 shadow-md transition-all duration-300 transform hover:text-gray-900 hover:bg-gray-50 hover:shadow-lg hover:-translate-y-1"
                >
          ...
          <Card className="mb-8 border-0 shadow-lg backdrop-blur-sm bg-white/80">
            <CardContent className="pt-6">
              <div className="relative">
                <Search className="absolute left-4 top-1/2 w-5 h-5 text-gray-400 transform -translate-y-1/2" />                <Input
                  type="text"
            ...
            <CardHeader className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-t-lg border-b border-gray-200">
              <CardTitle className="flex justify-between items-center text-xl">
                <div className="flex items-center">
                  <div className="flex justify-center items-center mr-3 w-8 h-8 rounded-full" style={{ backgroundColor: '#0093DE' }}>
                    <Users className="w-4 h-4 text-white" />
                  </div>
                  <span className="text-gray-800">Admin List ({searchQuery ? filteredAdmins.length : admins.length})</span>
                </div>
                {searchQuery && (
                  <Badge variant="secondary" className="text-xs text-blue-800 bg-blue-100 border-blue-200">
                    Filtered Results
                  </Badge>
                )}
              </CardTitle>
              ...
              {loading ? (
                <div className="py-12 text-center">
                  <div className="mx-auto mb-4 w-12 h-12 rounded-full border-b-2 animate-spin" style={{ borderColor: '#0093DE' }}></div>
                  <p className="font-medium text-gray-600">Loading admin accounts...</p>
                </div>
              ) : (
                <>
                      ...
                      <table className="w-full">
                        <thead>
                          <tr className="bg-gray-50 border-b border-gray-200">
                            <th className="px-6 py-4 font-semibold text-left text-gray-900">Admin Info</th>
                            <th className="px-6 py-4 font-semibold text-left text-gray-900">Role</th>
                            <th className="px-6 py-4 font-semibold text-left text-gray-900">Created Date</th>
                            <th className="px-6 py-4 font-semibold text-left text-gray-900">Status</th>
                            {isSuperAdmin && <th className="px-6 py-4 font-semibold text-center text-gray-900">Actions</th>}
                          </tr>
                        </thead>
                        <tbody>
                            ...
                            >
                              <td className="px-6 py-4">
                                <div className="flex items-center space-x-4">
                                  <div className="flex justify-center items-center w-10 h-10 rounded-full shadow-md" style={{ backgroundColor: '#0093DE' }}>
                                ...
                                >
                                  {admin.role === 'superadmin' ? (
                                    <><Crown className="mr-1 w-4 h-4" />Super Admin</>
                                  ) : (
                                    'Editor'
                                  )}
                                </Badge>
                                  ...
                                  {String(admin.id) !== String(user?.id) ? (
                                    <div className="flex justify-center items-center space-x-2">
                                      ...
                                      <Button
                                        ...
                                        title="Delete Admin"
                                        className="bg-gradient-to-r from-red-500 to-red-600 rounded-2xl shadow-md transition-all duration-300 transform hover:from-red-600 hover:to-red-700 hover:shadow-lg hover:-translate-y-1"
                                      >
            ...
            <div className="flex fixed inset-0 z-50 justify-center items-center p-4 bg-black bg-opacity-50 backdrop-blur-sm">
              <Card className="w-full max-w-md border-0 shadow-2xl backdrop-blur-sm bg-white/95">
                ...
                <CardContent className="p-6">                  <form onSubmit={handleCreateAdmin} className="space-y-6">
                  ...
                  <div>
                    <label className="block mb-2 text-sm font-semibold text-gray-700">Email Address</label>                      <Input
                      type="email"
                      value={newAdminEmail}
                  ...
                  <div>
                    <label className="block mb-2 text-sm font-semibold text-gray-700">Password</label>                      <Input
                      type="password"
                  ...
                  <div className="flex pt-4 space-x-3">                      <Button
                    type="submit"
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="flex-1 py-3 font-medium text-gray-700 rounded-2xl border-2 border-gray-300 shadow-md transition-all duration-300 transform hover:bg-gray-50 hover:shadow-lg hover:-translate-y-1"
                    >
                      Cancel
                    </Button>
                  </div>
              ...
              <Card className="w-full max-w-md border-0 shadow-2xl backdrop-blur-sm bg-white/95">
                ...
                <CardContent className="p-6">
                  <form onSubmit={handleChangePassword} className="space-y-6">
                    <div>
                      <label className="block mb-2 text-sm font-semibold text-gray-700">Current Password</label>                      <Input
                        type="password"
                        value={oldPassword}
                    ...
                    <div>
                      <label className="block mb-2 text-sm font-semibold text-gray-700">New Password</label>                      <Input
                        type="password"
                        value={newPassword}
                    ...
                    <div>
                      <label className="block mb-2 text-sm font-semibold text-gray-700">Confirm New Password</label>                      <Input
                        type="password"
                    ...
                    >
                      {passwordLoading ? (
                        ...
                        className="flex-1 py-3 font-medium text-gray-700 rounded-2xl border-2 border-gray-300 shadow-md transition-all duration-300 transform hover:text-gray-900 hover:bg-gray-50 hover:shadow-lg hover:-translate-y-1 active:text-gray-900 focus:text-gray-900"
                        >
                        Cancel
                        </Button>
                    </div>
