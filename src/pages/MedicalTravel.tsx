...
const MedicalTravel = () => {
  ...
  const hospitals = [
    ...
    },
    {
      ...
      image: 'https://upload.wikimedia.org/wikipedia/commons/c/c4/FV_hospital.JPG'
    },
    {
      id: 3,
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="relative h-[60vh] flex items-center justify-center">
        ...
        <ScrollReveal direction="up" delay={200} className="relative z-10 px-4 text-center text-white">
        ...
        <div className="container px-4 mx-auto">
          <ScrollReveal direction="up" delay={200}>
            <div className="max-w-3xl mx-auto mb-16 text-center">
              ...
              <h2 className="mb-4 text-3xl font-bold">Our Medical Travel Services</h2>
          ...
          <div className="grid max-w-5xl grid-cols-1 gap-8 mx-auto md:grid-cols-3">
            {services.map((service, index) => (
              ...
              >
                <div 
                  className={`p-6 h-72 rounded-2xl border-l-4 ${service.id % 2 === 0 ? 'border-[#0093DE]' : 'border-[#64A86B]'} transition-all duration-300 hover:-translate-y-2 hover:shadow-xl ${
                    theme === 'light' 
                      ? 'bg-white shadow-md' 
            ...
            <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
              <ScrollReveal direction="left" delay={200}>
                <div>
                  ...
                  <h2 className="mb-6 text-3xl font-bold">Why Choose Our Medical Travel Services?</h2>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h3 className="mb-2 text-xl font-semibold">Internationally Accredited Facilities</h3>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <h3 className="mb-2 text-xl font-semibold">Privacy & Confidentiality</h3>
                        <p className={`${theme === 'light' ? 'text-gray-600' : 'text-gray-300'}`}>
              ...
              >
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className={`text-sm ${theme === 'light' ? 'text-[#0093DE]' : 'text-[#58b7e8]'} font-medium mb-4`}>{hospital.location}</p>
                    ...
                    <ul className="space-y-1">
                      {hospital.specialties.map((specialty, index) => (
                        <li key={index} className="flex items-start">
                          ...
                          <span className={`${theme === 'light' ? 'text-gray-600' : 'text-gray-300'}`}>{specialty}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
        ...
        <div className="container px-4 mx-auto">
          ...
          <ScrollReveal direction="up" delay={400}>
            <div className="max-w-2xl mx-auto">
              <form className={`p-8 rounded-2xl ${theme === 'light' ? 'bg-white' : 'bg-gray-800'} text-${theme === 'light' ? 'gray-800' : 'white'} shadow-xl`}>
                <div className="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2">
                  ...
                  <div>
                    <label className="block mb-1 text-sm font-medium" htmlFor="country">Country of Residence</label>
                    <input 
                      type="text" 
                      id="country" 
                      className={`w-full p-3 rounded-xl border ${
                ...
                <div className="mb-6">
                  <label className="block mb-1 text-sm font-medium" htmlFor="service">Medical Service of Interest</label>
                  <select 
                    id="service" 
                    className={`w-full p-3 rounded-xl border ${
                      theme === 'light' 
                ...
                <div className="mb-6">
                  <label className="block mb-1 text-sm font-medium" htmlFor="message">Additional Information</label>
                  <textarea 
                    id="message" 
                    rows={4}
                    className={`w-full p-3 rounded-xl border ${
                ...
                <div className="mb-6">
                  <label className="flex items-center">
                    ...
                    <span className="ml-2 text-sm">
                      I consent to the processing of my personal data for the purpose of receiving a medical consultation.
                    </span>
                  </label>
                </div>
