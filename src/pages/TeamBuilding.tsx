...
const TeamBuilding = () => {
  ...
  return (
    <>
      <SEO
        title={pageConfigs.teamBuilding.title}
        description={pageConfigs.teamBuilding.description}
        keywords={pageConfigs.teamBuilding.keywords}
        url="https://leolovestravel.com/team-building"
        type="website"
      />
      <StructuredData
        type="TravelAgency"
        data={pageConfigs.teamBuilding.structuredData}
      />
      <div
          ...
          <div className="container px-4 mx-auto">
            ...
            <div className="grid max-w-6xl grid-cols-1 gap-8 mx-auto md:grid-cols-2 lg:grid-cols-4">
              {services.map((service, index) => (
                ...
                >
                  <div
                    className={`rounded-2xl overflow-hidden transition-all h-full duration-300 hover:-translate-y-2 hover:shadow-xl ${theme === "light"
                        ? "bg-white shadow-md"
        ...
        >
          ...
          <div className="relative grid max-w-5xl grid-cols-1 gap-8 mx-auto md:grid-cols-3">
            <ScrollReveal direction="left" delay={300} distance={40}>
              <div
                className={`p-6 pb-12 rounded-2xl transition-all duration-300 h-full hover:-translate-y-2 hover:shadow-xl ${theme === "light" ? "bg-[#F2F7FC]" : "bg-gray-700"
                  }`}
              >
            ...
            <ScrollReveal direction="up" delay={400} distance={40}>
              <div
                className={`relative p-6 pb-12 rounded-2xl h-full transition-all duration-300 hover:-translate-y-2 hover:shadow-xl ${theme === "light" ? "bg-[#F2F7FC]" : "bg-gray-700"
                  }`}
              >
                <div className="text-[#0093DE] mb-4">
                  <svg
          ...
          <div className="container px-4 mx-auto">
            ...
            <div className="grid max-w-5xl grid-cols-1 gap-12 mx-auto md:grid-cols-2">
              {caseStudies.map((study, index) => (
                ...
                >
                  <div
                    className={`rounded-2xl h-full overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:shadow-xl ${theme === "light"
                        ? "bg-white shadow-lg"
