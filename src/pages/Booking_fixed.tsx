  ...
  const validateForm = () => {
    ...
    formData.travelers.forEach((traveler, index) => {
      ...
      if (!traveler.passportNumber.trim()) {
        newErrors[`traveler_${index}_passportNumber`] = 'Passport number is required';
      }
      if (!traveler.passportExpiry) {
        newErrors[`traveler_${index}_passportExpiry`] = 'Passport expiry date is required';
      }
    });
                    ...
                    <div>
                      ...
                      <Popover>
                        <PopoverTrigger asChild>
                          ...
                          >
                            <CalendarIcon className="mr-2 h-4 w-4" />
                            {formData.returnDate ? format(formData.returnDate, 'PPP') : 'Pick return date'}
                          </Button>
                        </PopoverTrigger>
                        <PopoverContent className="w-auto p-0">
                          <Calendar
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <Input
                            ...
                            className={errors[`traveler_${index}_firstName`] ? 'border-red-500' : ''}
                            placeholder="First name"
                          />
                          {errors[`traveler_${index}_firstName`] && (
                            <p className="text-red-500 text-sm mt-1">{errors[`traveler_${index}_firstName`]}</p>
                          )}
                        </div>
                        <div>
                          ...
                          <Input
                            ...
                            className={errors[`traveler_${index}_lastName`] ? 'border-red-500' : ''}
                            placeholder="Last name"
                          />
                          {errors[`traveler_${index}_lastName`] && (
                            <p className="text-red-500 text-sm mt-1">{errors[`traveler_${index}_lastName`]}</p>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <Input
                            ...
                            className={errors[`traveler_${index}_passportNumber`] ? 'border-red-500' : ''}
                            placeholder="Passport number"
                          />
                          {errors[`traveler_${index}_passportNumber`] && (
                            <p className="text-red-500 text-sm mt-1">{errors[`traveler_${index}_passportNumber`]}</p>
                          )}
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <Popover>
                            <PopoverTrigger asChild>
                              ...
                              >
                                <CalendarIcon className="mr-2 h-4 w-4" />
                                {traveler.dateOfBirth ? format(traveler.dateOfBirth, 'PPP') : 'Pick date of birth'}
                              </Button>
                            </PopoverTrigger>
                            <PopoverContent className="w-auto p-0">
                              <Calendar
                        ...
                        <div>
                          ...
                          <Popover>
                            <PopoverTrigger asChild>
                              ...
                              >
                                <CalendarIcon className="mr-2 h-4 w-4" />
                                {traveler.passportExpiry ? format(traveler.passportExpiry, 'PPP') : 'Pick expiry date'}
                              </Button>
                            </PopoverTrigger>
                            <PopoverContent className="w-auto p-0">
                              <Calendar
                                ...
                                onSelect={(date) => handleTravelerChange(traveler.id, 'passportExpiry', date)}
                                disabled={(date) => date < new Date()}
                                initialFocus
                              />
                            </PopoverContent>
                          ...
                          {errors[`traveler_${index}_passportExpiry`] && (
                            <p className="text-red-500 text-sm mt-1">{errors[`traveler_${index}_passportExpiry`]}</p>
                          )}
                        </div>
                      </div>
                    </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24">
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    {selectedTour && typeof selectedTour === 'object' ? (
                      <>
                        <div>
                          <img
