    ...
    <div className={`min-h-screen ${theme === 'light' ? 'bg-[#F7F9FC] text-[#292F36]' : 'bg-[#1A202C] text-[#F7F9FC]'}`}>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <div className={`p-6 rounded-2xl ${theme === 'light' ? 'bg-white' : 'bg-gray-800'} shadow-md`}>
                <h3 className="text-xl font-bold mb-2">Do I need a visa to visit Vietnam?</h3>
              ...
              <div className={`p-6 rounded-2xl ${theme === 'light' ? 'bg-white' : 'bg-gray-800'} shadow-md`}>
                <h3 className="text-xl font-bold mb-2">How far in advance should I book airport transfers?</h3>
                <p className={`${theme === 'light' ? 'text-gray-600' : 'text-gray-300'}`}>
              ...
              <div className={`p-6 rounded-2xl ${theme === 'light' ? 'bg-white' : 'bg-gray-800'} shadow-md`}>
                <h3 className="text-xl font-bold mb-2">What types of accommodation can you book?</h3>
                <p className={`${theme === 'light' ? 'text-gray-600' : 'text-gray-300'}`}>
              ...
              <div className={`p-6 rounded-2xl ${theme === 'light' ? 'bg-white' : 'bg-gray-800'} shadow-md`}>
                <h3 className="text-xl font-bold mb-2">How do I stay connected while traveling in Vietnam?</h3>
                <p className={`${theme === 'light' ? 'text-gray-600' : 'text-gray-300'}`}>
      ...
      <section className="bg-gradient-to-r from-[#58b7e8] to-[#6dc0eb] text-white py-20 rounded-t-3xl">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready for a Hassle-Free Vietnam Experience?</h2>
          <p className="text-xl max-w-3xl mx-auto mb-10 text-white/90">
            Let us take care of all the details so you can focus on creating unforgettable memories
          </p>
