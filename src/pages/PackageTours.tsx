...
const TourListSkeleton = ({ theme }: { theme: string }) => (
  ...
  >
    {/* Image skeleton */}
    <div
      className={`h-48 md:w-1/3 md:h-auto animate-pulse ${
        theme === "light" ? "bg-gray-200" : "bg-gray-700"
      }`}
    />

    {/* Content skeleton */}
    <div className="flex flex-col p-6 space-y-3 md:w-2/3">
      {/* Title and rating skeleton */}
      <div className="flex items-start justify-between">
        <div
          className={`h-7 w-3/4 rounded animate-pulse ${
            theme === "light" ? "bg-gray-200" : "bg-gray-700"
          }`}
        />
        <div
...
const PackageTours = () => {
  ...
  return (
    <>
      ...
      >
        <SEOBreadcrumb /> {/* Working dual range slider styles */}
        <style>{`
        ...
        .dual-range-max.priority {
          z-index: 4;
        }

        /* Enhanced styling for the thumb of the priority (min) slider */
        .dual-range-min.priority::-webkit-slider-thumb {
          /* Add an outer glow to make it more distinct when on top */
          box-shadow: 0 0 0 2px #0093DE, 0 0 0 4px white, 0 2px 8px rgba(0, 0, 0, 0.3);
          /* The 0 0 0 4px white ensures the original white border effect is maintained or enhanced */
        }
          .dual-range-max.priority::-webkit-slider-thumb {
          /* Add an outer glow to make it more distinct when on top */
          box-shadow: 0 0 0 2px #0093DE, 0 0 0 4px white, 0 2px 8px rgba(0, 0, 0, 0.3);
          /* The 0 0 0 4px white ensures the original white border effect is maintained or enhanced */
        }

        .dual-range-min.priority::-moz-range-thumb {
          /* Add an outer glow for Firefox */
          box-shadow: 0 0 0 2px #0093DE, 0 0 0 4px white, 0 2px 8px rgba(0, 0, 0, 0.3);
        }
        
          .dual-range-max.priority::-moz-range-thumb {
          /* Add an outer glow for Firefox */
          box-shadow: 0 0 0 2px #0093DE, 0 0 0 4px white, 0 2px 8px rgba(0, 0, 0, 0.3);
        }
      ...
      `}</style>
        {/* Hero Section */}
        <section className="relative py-32 mt-0 mb-8 overflow-hidden rounded-b-3xl">
          <div
            ...
            >
              ...
              >
                ...
                <div className="relative flex items-center justify-between mb-6">
                  ...
                  <span className="absolute mx-2 text-sm text-gray-400 translate-x-1/2 -translate-y-1/2 top-1/2 right-1/2">
                    to
                  </span>
                  <div
                    className={`px-3 py-2 rounded-lg ${
                ...
                <div className="flex justify-between mb-6 text-xs text-gray-400">
                  <span>
                    Slider Range: ${sliderRange[0]} - ${sliderRange[1]}
                  </span>
                  {tours.length > 0 && (
                    <span>
                      Tours: ${minPrice} - ${maxPrice}
              ...
              <div className="mb-6">
                ...
                >
                  ...
                  <span className="font-semibold">
                    {filteredTours.length > 0 ? indexOfFirstTour + 1 : 0}-
              ...
              {filteredTours.length === 0 ? (
                    ...
                    >
                      ...
                      <div className="flex flex-col flex-1 p-6">
                        <div className="flex items-start justify-between mb-2">
                          <h3 className="flex-1 mr-2 text-lg font-bold line-clamp-2">
                            {tour.name}
                          </h3>
                ...
                <div className="space-y-6">
                  {currentTours.map((tour) => (
                    ...
                    >
                      {" "}
                      <div className="relative h-48 overflow-hidden md:h-full md:w-1/3">
                        <LazyImage
                          src={tour.image}
                          alt={tour.name}
                          preset="card"
                      ...
                      <div className="flex flex-col flex-1 p-6 md:w-2/3">
                        <div className="flex items-start justify-between mb-2">
